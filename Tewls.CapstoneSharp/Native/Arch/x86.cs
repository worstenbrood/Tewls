...
namespace Tewls.CapstoneSharp.Native.Arch
{
    ...
    public enum x86_op_type
    {
        ...
        X86_OP_FP = 3, ///< = CS_OP_FP (Floating-point operand).
    }

    /// <summary>Memory operand structure for X86</summary>

    public enum x86_xop_cc
    {
    ...
    /// <summary>AVX broadcast type</summary>
    ...
    /// <summary>SSE Code Condition type</summary>
    ...
    /// <summary>AVX Code Condition type</summary>
    ...
    /// <summary>AVX static rounding mode type</summary>
    ...
    /// <summary>Instruction prefixes - to be used in cs_x86.prefix[]</summary>
